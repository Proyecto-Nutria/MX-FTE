...
def create_md_table(listings):
    table = ""
    table += "| Compañía | Rol | Lugar | Nivel | Aplicación/Link | Fecha publicación |\n"
    table += "| ------- | ---- | -------- | ----- | ---------------- | ----------- |\n"
    ...
    for listing in listings:
        ...
        table += f"| {company} | {position} | {location} | {levels} | {link} | {date_posted} |\n"
...
def checkSchema(listings):
    props = ["source", "company_name",
             ...
             "date_posted", "url", "locations", "company_url", "level",
             "english"]
    for listing in listings:
        for prop in props:
